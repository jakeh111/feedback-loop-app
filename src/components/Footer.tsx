            ...
            <div className="bg-card border rounded-lg p-6 text-card-foreground">
                <div className="flex flex-col md:flex-row gap-8 items-center justify-between">
                    <div className="flex-grow">
                         <p className="text-sm text-muted-foreground">&copy; {new Date().getFullYear()} TrackPolish. All Rights Reserved.</p>
                         <p className="mt-1 text-xs text-muted-foreground">Background images courtesy of <a href="https://unsplash.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary">Unsplash</a>.</p>
                    </div>
